...
**プロダクトビジョン**: 「HPBの文章運用が、30分のAIチャットで1週間分完了する世界」
...
| AI（テキスト） | Gemini 2.0 Flash |
| AI（画像） | Nanobanana (Gemini Image Generation) |
...
- Gemini API呼び出しは`services/gemini_service.py`に集約し、他サービスは直接呼ばない
